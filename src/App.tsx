...
function App() {
  ...
  return (
    <div
      className="swiss-grid min-h-screen w-full md:h-screen md:overflow-hidden"
      data-theme={theme}
    >
      ...
      <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-[1000] flex flex-row md:flex-col gap-2">
        <button
          ...
          className="px-2 md:px-4 py-1 md:py-2 bg-[var(--text-primary)] text-[var(--text-inverse)] border-2 border-[var(--border-color)] font-bold uppercase text-[10px] md:text-xs tracking-widest hover:bg-[var(--bg-tertiary)] hover:text-[var(--text-primary)]"
        >
      ...
      <div className="col-span-12 md:col-span-8 row-span-4 md:row-span-2 swiss-cell border-b-4 md:border-r-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 overflow-hidden bg-[var(--bg-secondary)]">
        ...
        <div className="text-left md:text-right shrink-0">
          <div className="font-bold text-xl md:text-3xl uppercase tracking-tighter leading-none mb-1">
            {t("subtitle")}
          </div>
          <div className="text-[10px] md:text-xs font-black opacity-60 tracking-widest uppercase">
            {t("style_label")}
          </div>
        </div>
      </div>
      ...
      <div className="col-span-12 md:col-span-4 row-span-8 md:row-span-6 swiss-cell border-b-4 flex flex-col min-h-[400px] md:min-h-0">
        <div className="bg-[var(--text-primary)] text-[var(--text-inverse)] px-2 py-1 absolute top-0 left-0 text-xs font-bold uppercase z-10">
      ...
      <div className="col-span-6 md:col-span-4 row-span-4 swiss-cell border-b-4 border-r-4 flex flex-col justify-between py-6 overflow-hidden">
        <div className="bg-[var(--text-primary)] text-[var(--text-inverse)] px-2 py-1 self-start text-xs font-bold uppercase">
          {t("apparent")}
        </div>
      ...
      >
        <div className="font-bold text-[10px] md:text-xs uppercase">
          {t("precision")} v1.0
        </div>
